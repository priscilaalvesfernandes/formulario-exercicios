	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<!-- chamando os valores do checkbox -->
				...
				<!-- botão do tipo radio, seleciona apenas uma opção -->
				...
				<Rotulo nome="Prioridade">
					<select v-model="prioridade">
						<option v-for="prioridade in prioridades"
							...
							:selected="prioridade.codigo === 1"> <!-- estritamente igual -->
...
<!-------------------------- mostrar o resultado --------------------------------------------->
			<div class="painel" v-else>
				...
				<Rotulo nome="Mensagem">
					...
					<!-- style="white-space: pre -> propriedade que define a quebra de linha dentro de um text area -->
				</Rotulo>
